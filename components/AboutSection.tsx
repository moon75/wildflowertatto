    ...
    <section className="bg-bone">
      <div className="px-6 py-16 md:py-24 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          {/* Left: image cluster */}
          <div className="relative max-w-[300px] mx-auto lg:mx-0 w-full">
            <motion.h2
            ...
            >
              <Image src={limeTattoo} alt="Botanical lime tattoo by Lydia Szubert" className="w-full h-auto" sizes="(min-width: 1024px) 340px, 75vw" />
            </motion.div>

            <motion.div
              className="w-3/4 ml-auto -mt-[10%] rotate-[3deg] shadow-soft overflow-hidden rounded-lg"
              initial={{ opacity: 0, y: 30, rotate: 3 }}
              whileInView={{ opacity: 1, y: 0, rotate: 3 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7, ease, delay: 0.15 }}
            >
              <Image src={dogsTattoo} alt="Three dogs micro realism tattoo by Lydia Szubert" className="w-full h-auto" sizes="(min-width: 1024px) 340px, 75vw" />
            </motion.div>
          </div>
